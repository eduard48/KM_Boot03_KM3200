...
*
****************************************************************************
*	Загрузчик для контроллеров КМ (ATMEGA168)
*  В проекте надо включить использование внешнего Makefile !!!
...
*
* Написана для ATmega168PA для контроллеров SEM КМ01-3200.М - работает!!!
*
* ------------- Прошивка фъюсов --------------------------------------------------
